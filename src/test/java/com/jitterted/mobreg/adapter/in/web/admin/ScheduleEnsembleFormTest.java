...
class ScheduleEnsembleFormTest {
    ...
    @Test
    public void Form_converts_date_time_based_on_given_timezone() throws Exception {
    ...
    @Test
    public void Ensemble_date_time_converted_to_form_based_date_and_time_fields() throws Exception {
